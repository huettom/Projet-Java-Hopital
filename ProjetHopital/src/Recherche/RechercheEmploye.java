 ...
 * @author tomhuet
 */
public class RechercheEmploye extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Recherche Employé");
    ...
    public void rchemploye() {
        ...
        if (("".equals(recupnum))&&("".equals(recupnom))) {
            this.requete1 = "SELECT * FROM `hopital`.`employe`";
        }else
        {
            if("".equals(recupnom))
            {
               this.requete1 = "SELECT * FROM `hopital`.`employe` WHERE `numero` = "+ recupnum +"";
               
            }else 
            {
                if("".equals(recupnum)) {
                    
                    this.requete1 = "SELECT * FROM `employe` WHERE `nom` = '"+ recupnom +"'";
                    
                }else this.requete1 = "SELECT * FROM `employe` WHERE `numero` = "+ recupnum +" AND `nom` = '"+ recupnom +"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RechercheEmploye.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
