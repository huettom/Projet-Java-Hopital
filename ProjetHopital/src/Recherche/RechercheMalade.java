 ...
 * @author tomhuet
 */
public class RechercheMalade extends JFrame {
    
    
    public RechercheMalade() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Recherche Malade");
    ...
    public void rchmalade() {
        ...
        if (("".equals(recupnum))&&("".equals(recupnom))) {
            this.requete1 = "SELECT * FROM `hopital`.`malade`";
        }else
        {
            if("".equals(recupnom))
            {
               this.requete1 = "SELECT * FROM `hopital`.`malade` WHERE `numero` = "+ recupnum +"";
               
            }else 
            {
                if("".equals(recupnum)) {
                    
                    this.requete1 = "SELECT * FROM `malade` WHERE `nom` = '"+ recupnom +"'";
                    
                }else this.requete1 = "SELECT * FROM `malade` WHERE `numero` = "+ recupnum +" AND `nom` = '"+ recupnom +"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RechercheMalade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
