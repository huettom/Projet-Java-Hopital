 ...
 * @author tomhuet
 */
public class RechercheHospi extends JFrame {
    
    public RechercheHospi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Recherche Hospitalisation");
    ...
    public void rchmalade() {
        ...
        recupnumchambre = jTextField2.getText();
        
        if (("".equals(recupnum))&&("".equals(recupnumchambre))) {
            this.requete1 = "SELECT * FROM `hopital`.`hospitalisation`";
        }else
        {
            if("".equals(recupnumchambre))
            {
               this.requete1 = "SELECT * FROM `hopital`.`hospitalisation` WHERE `no_malade` = "+ recupnum +"";
               
            }else 
            {
                if("".equals(recupnum)) {
                    
                    this.requete1 = "SELECT * FROM `hospitalisation` WHERE `no_chambre` = "+ recupnumchambre +"";
                    
                }else this.requete1 = "SELECT * FROM `hospitalisation` WHERE `no_malade` = "+ recupnum +" AND `no_chambre` = "+ recupnumchambre +"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RechercheHospi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    protected String recupnumchambre;
