 ...
 * @author tomhuet
 */
public class MAJemploye extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Employé");
        jPanel1.add(jLabel1);
    ...
    public void up() {
        ...
        try{
            ...
            requete1 = "UPDATE `employe` "
                    + "SET `numero`='"+jTextField1.getText()+"',`nom`='"+jTextField2.getText()+"',`prenom`='"+jTextField3.getText()+"',`adresse`='"+jTextField4.getText()+"',`tel`='"+jTextField5.getText()+"' "
                    + "WHERE `employe`.`numero`="+jTextField1.getText()+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MAJemploye.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
