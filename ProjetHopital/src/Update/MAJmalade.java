 ...
 * @author tomhuet
 */
public class MAJmalade extends JFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setBounds(330, 580, 260, 60);
    ...
    public void up() {
        ...
        try{
            ...
            requete1 = "UPDATE `malade` SET `numero`='"+jTextField1.getText()+"',`nom`='"+jTextField2.getText()+"',`prenom`='"+jTextField3.getText()+"',`adresse`='"+jTextField4.getText()+"', `tel`='"+jTextField5.getText()+"',`mutuelle`='"+jTextField6.getText()+"' WHERE `malade`.`numero`="+jTextField1.getText()+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MAJmalade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
