 ...
 * @author tomhuet
 */
public class MAJinfirmier extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Infirmier");
        jPanel1.add(jLabel1);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(170, 310, 120, 20);

        jLabel4.setText("Rotation");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(170, 400, 120, 20);
    ...
    public void up() {
        ...
        try{
            ...
            requete1 = "UPDATE `infirmier` SET `numero`='"+jTextField1.getText()+"',`code_service`='"+jTextField2.getText()+"',`rotation`='"+jTextField3.getText()+"',`salaire`='"+jTextField4.getText()+"' WHERE `infirmier`.`numero`="+jTextField1.getText()+"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MAJinfirmier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
