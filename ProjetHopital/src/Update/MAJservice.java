 ...
 * @author tomhuet
 */
public class MAJservice extends JFrame {
    ...
    public void up() {
        ...
        try{
            ...
            requete1 = "UPDATE `service` "
                    + "SET `code`='"+jTextField1.getText()+"',`nom`='"+jTextField2.getText()+"',`batiment`='"+jTextField3.getText()+"',`directeur`='"+jTextField4.getText()+"' "
                    + "WHERE `service`.`code`='"+jTextField1.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MAJservice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
