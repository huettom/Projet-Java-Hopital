 ...
 * @author tomhuet
 */
public class MAJchambre extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Chambre");
        jPanel1.add(jLabel1);
    ...
    public void up() {
        ...
        try{
            ...
            requete1 = "UPDATE `chambre` SET `code_service`='"+jTextField1.getText()+"',`no_chambre`='"+jTextField2.getText()+"',`surveillant`='"+jTextField3.getText()+"',`nb_lits`='"+jTextField4.getText()+"' WHERE `chambre`.`no_chambre`="+jTextField2.getText()+"";
