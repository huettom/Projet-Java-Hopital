 ...
 * @author tomhuet
 */
public class AjoutChambre extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ajouter/Supprimer Chambre");
        jPanel1.add(jLabel1);
    ...
    public void ajouter() {
        ...
        try{
            ...
            requete1 = "INSERT INTO `chambre`(`code_service`, `no_chambre`,`surveillant`, `nb_lits`) "
    ...
    public void supp() {
        ...
        try{
            ...
            requete1 = "DELETE FROM `chambre` WHERE `chambre`.`code_service` = '"+jTextField1.getText()+"' AND CONCAT(`chambre`.`no_chambre`) = '"+jTextField2.getText()+"'";
