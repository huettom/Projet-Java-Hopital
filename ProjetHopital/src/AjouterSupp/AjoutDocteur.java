 ...
 * @author tomhuet
 */
public class AjoutDocteur extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ajouter/Supprimer Docteur");
        jPanel1.add(jLabel1);
    ...
    public void ajouter() {
        ...
        try{
            ...
            requete1 = "INSERT INTO `docteur`(`numero`, `specialite`) "
    ...
    public void supp() {
        ...
        try{
            ...
            requete1 = "DELETE FROM `docteur` WHERE CONCAT(`docteur`.`numero`) = '"+jTextField1.getText()+"'";
            maconnexion.executeUpdate(requete1);
