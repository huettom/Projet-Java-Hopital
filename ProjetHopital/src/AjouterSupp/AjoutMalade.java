 ...
 * @author tomhuet
 */
public class AjoutMalade extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ajouter/Supprimer Malade");
        jPanel1.add(jLabel1);
        ...
        jLabel7.setText("Mutuelle");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(650, 600, 120, 20);
        
        jPanel1.add(jTextField6);
        jTextField6.setBounds(800, 580, 260, 60);
    ...
    public void ajouter() {
        ...
        try{
            ...
            requete1 = "INSERT INTO `malade`(`numero`, `nom`, `prenom`, `adresse`, `tel`, `mutuelle`) "
                + "VALUES('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"')";
    ...
    public void supp() {
        ...
        try{
            ...
            requete1 = "DELETE FROM `malade` WHERE CONCAT(`malade`.`numero`) = '"+jTextField1.getText()+"'";
            maconnexion.executeUpdate(requete1);
