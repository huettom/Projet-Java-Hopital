 ...
 * @author tomhuet
 */
public class AjoutService extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ajouter/Supprimer Service");
        jPanel1.add(jLabel1);
    ...
    public void ajouter() {
        ...
        try{
            ...
            requete1 = "INSERT INTO `service`(`code`, `nom`,`batiment`, `directeur`) "
    ...
    public void supp() {
        ...
        try{
            ...
            requete1 = "DELETE FROM `service` WHERE CONCAT(`service`.`code`) = '"+jTextField1.getText()+"'";
